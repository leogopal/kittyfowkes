function Spin2WinWheel() {
			...
			if (spinDestinationArray.length > 0) {
				...
				for (var i = 0; i < spinDestinationArray.length; i++) {
					...
					if (spinDestinationArray[i] > numSegments || spinDestinationArray[i] === 0) {
						...
						toast.style.backgroundColor = '#ef3f23';
						return;
					}
	...
	this.onMaxSpinsReached = onMaxSpinsReached;
	...
	this.init = function (e) {
		...
		onMaxSpinsReached = (e.onMaxSpinsReached) ? e.onMaxSpinsReached : function () {};
		playedEnough = (e.playedEnough) ? e.playedEnough : function () {};
	...
	// Stops a clever person from gaming the system.
